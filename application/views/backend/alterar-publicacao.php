                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="txt-titulo" class="form-control" name="txt-titulo" placeholder="Digite o titulo ..." value="<?php echo $publicacao->titulo; ?>">
                            </div>
                            <div class="form-group">
                                <label id="txt-subtitulo">Subtitulo</label>
                                <input type="text" id="txt-subtitulo" class="form-control" name="txt-subtitulo" placeholder="Digite o subtitulo ..." value="<?php echo $publicacao->subtitulo; ?>">
                            </div>
                            <div class="form-group">
                                <label id="txt-conteudo">Conteudo</label>
                                <textarea name="txt-conteudo" id="txt-conteudo" class="form-control"><?php echo $publicacao->conteudo; ?> </textarea>
                            </div>
                            <div class="form-group">
                                <label id="txt-data">Data</label>
                                <input type="datetime-local" id="txt-data" class="form-control" name="txt-data" placeholder="Digite o data.." value="<?php echo strftime('%Y-%m-%dT%H:%M:%S', strtotime($publicacao->data)); ?>">
                            </div>
                            <input type="hidden" name="txt-id" value="<?php echo $publicacao->id; ?>">
                            
                            <button type="submit" class="btn btn-default">Salvar Alteraçoes</button>
                            <?php
                            echo form_close();
                            ?>
                        </div>
