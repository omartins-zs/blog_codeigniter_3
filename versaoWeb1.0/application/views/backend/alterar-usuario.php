                        ...
                        <div class="col-lg-12">
                            ...
                            foreach ($usuarios as $usuario) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="txt-nome" class="form-control" name="txt-nome" placeholder="Digite o nome do usuario..." value="<?php echo $usuario->nome ?>">
                                </div>
                                <div class="form-group">
                                    <label id="txt-email">Email</label>
                                    <input type="text" id="txt-email" class="form-control" name="txt-email" placeholder="Digite o email do usuario..." value="<?php echo $usuario->email ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="txt-user" class="form-control" name="txt-user" placeholder="Digite o user do usuario..." value="<?php echo $usuario->user ?>">
                                </div>
                                <div class="form-group">
